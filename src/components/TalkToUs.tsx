...
const HOW = [
  [
    ...
    "What you do, how many people, how you work now. Ten minutes on the phone.",
  ],
  [
    "02",
      ...
      <div className="shell">
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-20">
          <div>
            ...
            <Reveal delay={240}>
              <div className="mt-9 border border-line bg-raised p-6 sm:p-8">
                <p className="chrome mb-4 border-b border-line pb-3">Talk to us</p>
                <h3 className="display text-[22px] leading-tight sm:text-[26px]">
                  Four short questions, then we reply within a day.
                </h3>
                <p className="mt-3 max-w-[48ch] text-[14px] leading-relaxed text-ink-2">
                  Tell us how you take bookings today and what it's costing you. It takes under a
                  minute, nothing is charged, and a real person reads every word.
                </p>
                <Link to="/get-in-touch" className="btn-brand mt-7 inline-flex">
                  Contact us
                </Link>
              </div>
            </Reveal>
            ...
            <Reveal delay={280}>
              <div className="mt-8 border border-line bg-raised p-6">
                ...
                <p className="text-[13.5px] leading-relaxed text-ink-2">
                  Kairo has been running a Melbourne salon's bookings, payments and customer emails
                  in production since day one. The screens on this page are that same system, filled
                  with invented clients so no real business's data appears anywhere on this site.
                </p>
              </div>
            </Reveal>
          </div>
