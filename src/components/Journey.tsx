...
function StepCopy({ step }: { step: Step }) {
  return (
    <>
      ...
      <p className="mt-5 max-w-[52ch] text-[14.5px] leading-[1.6] text-ink-2">
        {step.body}
      </p>
          ...
          <div>
            ...
            <Reveal delay={120}>
              <p className="lede mt-6">
                From the first coffee to the last invoice. Every frame below is
                the real system running, set on the same morning at 11:40 —
                four visits done, one in the chair, the afternoon filling up.
                Keep scrolling and the day plays out.
              </p>
            </Reveal>
              ...
              <ol className="space-y-2.5">
                {STEPS.map((s) => (
                  <li key={s.n} className="flex items-baseline gap-3">
                    <span className="chrome text-ink">
                      {s.n}
                    </span>
