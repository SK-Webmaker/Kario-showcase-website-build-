...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Your business is a single database file. It can be copied, backed up or moved in one move. Nothing is pooled with another business, because there is no shared pool.",
  },
  {
    n: "03",
              ...
              <div className="border border-line-2 bg-ground">
                ...
                {CHECKS.map(([k, v]) => (
                  ...
                  >
                    ...
                    <span className="text-[11px] text-brand-deep" aria-hidden="true">
                      OK
                    </span>
                  </div>
                ))}
                <div className="px-4 py-4">
                  <p className="text-[12px] leading-relaxed text-ink-3">
                    When one of these is wrong, Kairo says so on the dashboard — in plain English,
                    on the day it becomes true, not in a log file nobody opens.
                  </p>
                </div>
              </div>
            </div>
