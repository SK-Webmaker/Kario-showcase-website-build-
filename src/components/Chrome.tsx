 ...
 * than a brochure, which is exactly the register an owner should
...
/** The bottom status bar: where the business is, the time, the cursor. */
  ...
  return (
    ...
    >
      <div className="shell flex items-center justify-between py-2">
        <span className="chrome tabular">Melbourne AU · Live in production</span>
